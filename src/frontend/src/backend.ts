...
export class Backend implements backendInterface {
    ...
    async getCallHistory(): Promise<Array<CallRecord>> {
        if (this.processError) {
            try {
    ...
    async logCall(arg0: Principal, arg1: Variant_video_voice, arg2: bigint, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logCall(arg0, to_candid_variant_n24(this._uploadFile, this._downloadFile, arg1), arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markMessageSeen(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markMessageSeen(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerOrUpdateProfile(arg0: string, arg1: ExternalBlob, arg2: string): Promise<Profile> {
        if (this.processError) {
            try {
                const result = await this.actor.registerOrUpdateProfile(arg0, await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg1), arg2);
                return from_candid_Profile_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: Principal, arg1: string, arg2: ExternalBlob): Promise<Message> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg2));
                return from_candid_Message_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_CallRecord_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CallRecord): CallRecord {
...
async function from_candid_Message_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Message): Promise<Message> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        avatarUrl: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.avatarUrl),
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        missed: value.missed,
        callType: from_candid_variant_n17(_uploadFile, _downloadFile, value.callType),
...
async function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        seen: value.seen,
        sender: value.sender,
        mediaUrl: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.mediaUrl),
        timestamp: value.timestamp,
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "video" in value ? Variant_video_voice.video : "voice" in value ? Variant_video_voice.voice : value;
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Profile>): Promise<Array<Profile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Profile_n11(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CallRecord>): Array<CallRecord> {
    return value.map((x)=>from_candid_CallRecord_n15(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Message>): Promise<Array<Message>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Message_n22(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blockedUsers: value.blockedUsers,
        displayName: value.displayName,
        avatarUrl: await to_candid_ExternalBlob_n25(_uploadFile, _downloadFile, value.avatarUrl),
        lastSeen: value.lastSeen
    };
}
...
function to_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_video_voice): {
    video: null;
} | {
    voice: null;
} {
    return value == Variant_video_voice.video ? {
        video: null
    } : value == Variant_video_voice.voice ? {
        voice: null
    } : value;
}
